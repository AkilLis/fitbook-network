          ...
          <div class="row tile_count">
			<div class="col-md-12">
				<div class="x_panel tile">
					...
					<div class="col-md-2 col-md-offset-1 tile_stats_count">
						  <span class="count_top"><i class="fa fa-user"></i> Бэлэн мөнгө</span>
						  <div class="count">250,000 ₮</div>
						</div>
						<div class="col-md-2 c tile_stats_count">
						...
						<div class="col-md-2  tile_stats_count">
						  <span class="count_top"><i class="fa fa-user"></i> Шагнал</span>
						...
						<div class="col-md-2 tile_stats_count">
						  <span class="count_top"><i class="fa fa-user"></i> Хуримтлал</span>
